...
export default function TrustPage() {
  return <>
    ...
    <footer className="site-footer page-frame">
      ...
      <p><a href="/privacy">Privacy notice</a> · <a href="/verify">Verify a report</a> · <a href="/case-study">Architecture case study</a> · <a href="/signing-keys.json">Public keys</a> · <a href="/">Return to analysis</a></p>
    </footer>
  </>;
}
